...
namespace ScratchCardAsset.Editor
{
	...
	[CustomEditor(typeof(ScratchCardManagerTrace))]
	public class ScratchCardManagerInspectorTrace : UnityEditor.Editor
	{
		...
		private EraseProgressTrace eraseProgress;
		...
		public override void OnInspectorGUI()
		{
			...
			if (EditorGUI.EndChangeCheck())
			{
				var cardRenderType = (ScratchCardManagerTrace.ScratchCardRenderType)renderType.enumValueIndex;
				switch (cardRenderType)
				{
					case ScratchCardManagerTrace.ScratchCardRenderType.MeshRenderer:
						...
						break;
					case ScratchCardManagerTrace.ScratchCardRenderType.SpriteRenderer:
						...
						break;
					case ScratchCardManagerTrace.ScratchCardRenderType.CanvasRenderer:
			...
			if (card.objectReferenceValue != null)
			{
				scratchCard = card.objectReferenceValue as ScratchCardTrace;
				if (scratchCard != null)
				{
					...
					{
						scratchCard.Mode = (ScratchCardTrace.ScratchMode) mode.enumValueIndex;
						scratchCardChanged = true;
					}
					...
					if (scratchCard.RenderTexture != null)
					{
						...
						if (Application.isPlaying)
						{
							...
							{
								eraseProgress = progress.objectReferenceValue as EraseProgressTrace;
							}
